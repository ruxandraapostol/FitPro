...
{
    public class AddRecipeValidation : AbstractValidator<AddRecipeModel>
    {
        public AddRecipeValidation(NutritionistService service)
        {
            RuleFor(u => u.Name)
               .NotEmpty().WithMessage("The Name field is required")
               .MaximumLength(100).WithMessage("The Name should not be longer than 100 charcters");
